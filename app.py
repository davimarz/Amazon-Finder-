...
<style>
    ...
    *, *:before, *:after {
    ...
    /* CLASSI NEUTRE E PROTETTE DA ADBLOCKER PER LA CONDIVISIONE */
    .c-actions-row {
        display: flex !important;
        flex-direction: row !important;
        justify-content: center !important;
    ...
    .c-btn-wa { background-color: #25D366 !important; }
    .c-btn-fb { background-color: #1877F2 !important; }
    ...
    with st.container(border=True):
        ...
        st.markdown(
            ...
            <div class='c-actions-row'>
                <button type='button' onclick="window.open('{wa_url}', '_blank')" class='c-btn-item c-btn-wa' title='WhatsApp'>{SVG_WA}</button>
                <button type='button' onclick="window.open('{fb_url}', '_blank')" class='c-btn-item c-btn-fb' title='Facebook'>{SVG_FB}</button>
