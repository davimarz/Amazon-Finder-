...
def ottieni_offerte_avanzate(
    ...
    # RISOLTO IL BUG DELLA SCHEDA SINGOLA:
    # Si attiva la ricerca su singolo ASIN solo se è un URL effettivo con http
    # o se è un codice ASIN alfanumerico Amazon rigoroso (es. B0...).
    # Parole generiche di 10 lettere (es. 'smartphone') eseguono la normale ricerca su catalogo.
    ...
    # Fallback su ricerca web completa se l'API non restituisce abbastanza risultati
